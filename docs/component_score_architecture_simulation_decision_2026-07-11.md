...
- commit: pending until this decision and routing are committed
- working tree: docs/routing change in progress
- push / merge: pending after required verification
