...
- `v8.3.1_macro_card_adaptive_off_and_protein_target_level_implementation_2026-07-10.md`
  ...
  - score formula, score curve tuning, anchor value, adaptive limiter, kcal/alcohol range display, tooltip/glossary, DailyCoach copy rewrite, scoreDeltaPreview, old records cleanup/reset/fallback은 열지 않는다.
