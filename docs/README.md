...
- `v8.3_implementation_entry_decision_2026-07-07.md`
  ...
  - 다음 본류는 명시적 v8.3 continuous scoring implementation이다.
...
7. 후속 후보 문서
   ...
   - `v8.2_macro_range_scoring_direction_realignment_decision_2026-07-06.md`
     - v8.2 macro range score 흐름을 `scoreDeltaPreview` 비교 확장이 아니라 fixed target score를 range-aware production score로 전환하는 본류로 재정렬하는 docs-only decision 문서다.
   ...
   - `v8.2_macro_range_production_score_implementation_decision_2026-07-06.md`
     - range-aware production score implementation이 실제로 열 때의 boundary를 정리한 docs-only decision 문서다.
