...
const actionScripts = {
  ...
  tabRecordsMealEditModal: "w.document.querySelector('#tabRecords')?.click(); await delay(300); w.document.querySelector('[data-edit-record-meal]')?.click();",
  tabWeekly: "w.document.querySelector('#tabWeekly')?.click();",
  tabWeekly1: "w.document.querySelector('#tabWeekly')?.click(); await delay(300); w.document.querySelector('[data-recent-flow-range=\"1\"]')?.click();",
...
const captures = [
  ...
  ["20_desktop_recent_1d", "rich", "tabWeekly1", 1280, 900],
